...
public class VentanaExpediente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tagsMotivo = new Componentes.TagInputControl();
        tagsEnfermedad = new Componentes.TagInputControl();
        ...
        btnEliminar = new Componentes.JImageBox();
        btnAgregar1 = new Componentes.JImageBox();
        btnModificar1 = new Componentes.JImageBox();
    ...
    private void modificar(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_btnModificar1MouseClicked
        ...
        expedienteSel.setObservaciones(limpiarCadena(txtObservaciones.getText()));
        expedienteSel.setTratamiento(limpiarCadena(txtTratamiento.getText()));
        String retorno;
    ...
    private Componentes.JImageBox btnAgregar1;
    private Componentes.JImageBox btnEliminar;
    private Componentes.JImageBox btnModificar1;
    ...
    private Componentes.TagInputControl tagsEnfermedad;
    private Componentes.TagInputControl tagsMotivo;
